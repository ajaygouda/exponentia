import {
  ...
  useSvgRef,
  useTicks
} from "./chunk-MQZHTMHV.js";
import {
  warnOnce
} from "./chunk-TTAICKHP.js";
import {
  NoSsr_default
} from "./chunk-GWN7EO74.js";
import {
  Popper_default
...
var AnimationContext = React8.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React9.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React10.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime3.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
var ChartsSurface = React12.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    ...
    children: [(0, import_jsx_runtime4.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime4.jsx)("desc", {
      children: desc
    }), children]
  }));
});
  ...
  return (0, import_jsx_runtime5.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold, index) => {
      ...
      return (0, import_jsx_runtime5.jsxs)(React13.Fragment, {
        children: [(0, import_jsx_runtime5.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime6.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
  ...
  return (0, import_jsx_runtime7.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime7.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse,
          scale,
          colorScale,
          colorMap,
...
var ResponsiveChartContainer = React20.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime14.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime14.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime14.jsx)("tbody", {
        children: (0, import_jsx_runtime14.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime14.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime14.jsx)(ChartsTooltipMark, {
              color,
      ...
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime16.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime16.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime16.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime16.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React31.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React31.useMemo(() => {
...
function LegendPerItem(props) {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React36.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React36.useMemo(() => {
  ...
  return (0, import_jsx_runtime20.jsx)(NoSsr_default, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime21.jsx)(LegendPerItem, _extends({}, other, {
...
//# sourceMappingURL=chunk-X7NNE32C.js.map
